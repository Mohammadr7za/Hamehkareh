...
return [
    ...
    'date_format' => ':attributeبا قالب :format مطابقت ندارد.',
    'different' => ':attributeو :دیگر باید متفاوت باشند.',
    ...
    'exists' => ':attributeانتخاب شده نامعتبر است.',
    ...
    'gte' => [
        ...
        'string' => ':attribute باید بزرگتر یا مساوی کاراکترهای :value باشد.',
        'array' => ':attribute باید موارد :value یا بیشتر داشته باشد.',
    ],
    'image' => ':attribute باید یک تصویر باشد.',
    'in' => ':attributeانتخاب شده نامعتبر است.',
    ...
    'required_if' => 'فیلد :attribute لازم است',
    'username' => 'نام کاربری',
    'email' => 'ایمیل',
    ...
    'prohibited_if' => 'فیلد :attribute زمانی که :other :value باشد ممنوع است.',
