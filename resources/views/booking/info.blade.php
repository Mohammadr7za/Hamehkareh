    ...
    <div class="pay-box">
        ...
        <div class="pay-booking-details">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 align-text" style="direction: ltr">
                    {{ jdate($bookingdata->date) ?? '-'}}
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="table-responsive bk-summary-table">
                <table class="table-sm title-color align-right w-100">
                    ...
                    <tr>
                        ...
                        <td class="bk-value">{{getPriceFormat($bookingdata->service->price)}}
