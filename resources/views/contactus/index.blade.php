...
{{--                            <a href="{{ route('contactus.create') }}" class="float-right mr-1 btn btn-sm btn-primary"><i class="fa fa-plus-circle"></i> {{ trans('messages.add_form_title',['form' => trans('messages.contactus')  ]) }}</a>--}}
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="card">
        ...
        <div class="row justify-content-between">
            <div>
                <div class="col-md-12">
                  <form action="{{ route('contactus.bulk-action') }}" id="quick-action-form" class="form-disabled d-flex gap-3 align-items-center">
                    @csrf
                ...
                data--submit="{{ route('contactus.bulk-action') }}"
                data-datatable="reload" data-confirmation='true'
                data-title="{{ __('contactus',['form'=>  __('contactus') ]) }}"
                title="{{ __('contactus',['form'=>  __('contactus') ]) }}"
    ...
    <script>
        ...
        window.renderedDataTable = $('#datatable').DataTable({
                ...
                ajax: {
                  "type"   : "GET",
                  "url"    : '{{ route("contactus.index_data") }}',
                  "data"   : function( d ) {
                    d.search = {
                      value: $('.dt-search').val()
                    };
