                                ...
                                <li style="pointer-events:none;">
                                    <div class="media gap-3">
                                        ...
                                        <div class="media-body ">
                                            ...
                                            <span>{{(jdate($customer->created_at))}}</span>
                                        </div>
                                    </div>
                                </li>
                            @endforeach
                    ...
                    <div class="card-body">
                        <ul class="common-list p-0">
                            ...
                            @foreach($data['dashboard']['upcomming_booking'] as $booking)
                                <li class="d-flex flex-wrap gap-2 align-items-start align-items-lg-center justify-content-between flex-column flex-lg-row "
                                    style="pointer-events:none;">
                                    <div class="media align-items-center gap-3">
                                        <div class="h-avatar is-medium h-5">
                                            <img class="avatar-50 rounded-circle bg-light" alt="user-icon"
                                                 src="{{ getSingleMedia($booking->customer,'profile_image', null) }}">
                                        </div>
                                        <div class="media-body ">
                                            <h5>#{{$booking->id}}</h5>

                                            <span>{{(jdate($booking->date))}}</span>

                                        </div>
                                    </div>
                                    <span
                                        class="badge rounded-pill py-2 px-3 badge-pending text-capitalize">{{__('messages.'.$booking->status)}}</span>
                                </li>
                            @endforeach
                        </ul>
                    </div>
