...
{{--                            <a href="#" class="search-toggle dropdown-toggle language-toggle" id="languageDropdownMenu"--}}
...
{{--                                ?>--}}
{{--                                <img src="{{ $selected_lang_flag }}" class="img-fluid" alt="lang"--}}
{{--                                     style="height: 30px; min-width: 30px; width: 30px;">--}}
{{--                                <span class="bg-primary"></span>--}}
{{--                            </a>--}}
{{--                            <div class="iq-sub-dropdown dropdown-menu language-dropdown-menu"--}}
...
{{--                                                           href="{{ route('switch-language',['locale'=> $lang['id'] ]) }}">--}}
{{--                                                                <?php--}}
                        ...
                        <li class="nav-item nav-icon dropdown">
                            <a href="#" class="nav-item nav-icon dropdown-toggle pr-0 search-toggle"
                               ...
                               aria-expanded="false">
                                ...
                                <span
                                    class="mb-0  user-name">{{ auth()->user()->first_name." ".auth()->user()->last_name }}</span>
                            </a>
